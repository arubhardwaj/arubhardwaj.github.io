...
const CONTENT = {
  ...
  it: {
    ...
    faqs: [
      ...
      { q: 'Accetti equity?', a: 'Solo come parte di un ingaggio Partnership — tariffa cash ridotta combinata con equity o un success bonus. Gli accordi solo in equity non sono offerti. Una tariffa di servizio è sempre richiesta.' },
  ...
  fr: {
    ...
    faqs: [
      ...
      { q: 'Prenez-vous de l\'equity ?', a: 'Uniquement dans le cadre d\'un engagement Partenariat — tarif cash réduit combiné à de l\'equity ou un bonus de succès. Les arrangements purement en equity ne sont pas proposés. Un service fee est toujours requis.' },
  ...
  de: {
    ...
    faqs: [
      ...
      { q: 'Nehmen Sie Equity?', a: 'Nur im Rahmen eines Partnerschafts-Engagements — reduzierte Cash-Gebühr kombiniert mit Equity oder einem Erfolgsbonus. Reine Equity-Vereinbarungen werden nicht angeboten. Eine Servicegebühr ist immer erforderlich.' },
