...
const translations = {
  ...
  engagementPartnershipDesc: {
    en: 'Reduced service fee + equity. For startups and long-term MVP builds where I go deep on your product.',
    it: 'Tariffa ridotta + equity. Per startup e sviluppo MVP a lungo termine dove mi immergo nel prodotto.',
    fr: 'Tarif réduit + equity. Pour startups et développement MVP long terme où je m\'investis dans votre produit.',
    de: 'Reduzierter Stundensatz + Equity. Für Startups und langfristige MVP-Entwicklung mit tiefer Produktbeteiligung.'
  },
  ...
  calcPartnershipNote: {
    en: 'Partnership deals (reduced cash + equity) can cut the cash component by 30-40% for aligned early-stage startups. A service fee is always required.',
    it: 'Accordi di Partnership (cash ridotto + equity) possono tagliare la componente cash del 30-40% per startup early-stage allineate. È sempre richiesta una tariffa di servizio.',
    fr: 'Les accords Partenariat (cash réduit + equity) peuvent réduire la part cash de 30-40 % pour les startups early-stage alignées. Un service fee est toujours requis.',
    de: 'Partnerschafts-Deals (reduzierter Cash-Anteil + Equity) können den Cash-Anteil für passende Early-Stage-Startups um 30-40 % senken. Eine Servicegebühr ist immer erforderlich.'
  },
  calcEngagementType: {
    en: 'Engagement type',
    it: 'Tipo di ingaggio',
  ...
  faq2A: {
    ...
    it: 'È un ingaggio ibrido: una tariffa cash ridotta (tipicamente 30–40% della mia standard) combinata con equity. La suddivisione esatta si discute caso per caso dopo aver parlato del tuo stadio, timeline, runway e obiettivi. La componente di service fee è sempre presente: è ciò che mantiene l\'ingaggio focalizzato e equo per entrambe le parti.',
    fr: 'C\'est un engagement hybride : un tarif cash réduit (généralement 30–40% de mon standard) combiné à de l\'equity. La répartition exacte se discute au cas par cas après avoir parlé de votre stade, calendrier, runway et objectifs. La composante service fee est toujours présente — c\'est ce qui maintient l\'engagement focalisé et équitable pour les deux parties.',
    de: 'Es ist ein hybrides Engagement: ein reduzierter Cash-Satz (typischerweise 30–40% meines Standards) kombiniert mit Equity. Die genaue Aufteilung wird von Fall zu Fall besprochen, nachdem wir über Ihre Phase, Zeitplan, Runway und Ziele gesprochen haben. Die Servicegebühr-Komponente ist immer vorhanden — sie hält das Engagement fokussiert und fair für beide Seiten.'
  },
  faq3Q: {
  ...
  faq8A: {
    en: 'Rarely, and only for startups I\'m deeply aligned with — on mission, market, and long-term collaboration. Equity-heavy co-founder arrangements need mutual conviction on both sides and a realistic path to milestones. More often than not, the Partnership model (reduced service fee + equity) is a better fit for both of us — it gets you senior technical leadership without the co-founder commitment, and it keeps my focus across a handful of great projects rather than locked into one.',
    it: 'Raramente, e solo per startup con cui c\'è un allineamento profondo — su missione, mercato e collaborazione a lungo termine. Gli accordi co-founder pesanti in equity richiedono convinzione reciproca da entrambe le parti e un percorso realistico verso i milestone. Il più delle volte, il modello Partnership (tariffa ridotta + equity) è più adatto per entrambi — ti dà leadership tecnica senior senza il commitment da co-founder e mantiene il mio focus su diversi grandi progetti invece di bloccarmi su uno solo.',
    fr: 'Rarement, et seulement pour des startups avec lesquelles je suis profondément aligné — sur la mission, le marché et la collaboration long terme. Les arrangements co-fondateur à forte equity nécessitent une conviction mutuelle des deux côtés et un chemin réaliste vers les milestones. Le plus souvent, le modèle Partenariat (tarif réduit + equity) est un meilleur fit pour nous deux — il vous donne un leadership technique senior sans l\'engagement de co-fondateur, et me garde concentré sur plusieurs grands projets plutôt qu\'enfermé dans un seul.',
    de: 'Selten, und nur für Startups, mit denen ich tief ausgerichtet bin — bei Mission, Markt und langfristiger Zusammenarbeit. Equity-lastige Mitgründer-Vereinbarungen erfordern beidseitige Überzeugung und einen realistischen Weg zu den Meilensteinen. Meistens ist das Partnerschafts-Modell (reduzierte Servicegebühr + Equity) für beide Seiten besser geeignet — es gibt Ihnen erfahrene technische Führung ohne Mitgründer-Commitment und hält meinen Fokus auf mehrere großartige Projekte verteilt statt auf eines fixiert.'
  },
  customizedSolutions: {
