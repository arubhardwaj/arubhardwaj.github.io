            ...
            <Card className="card-hover border-2 border-secondary/30 bg-secondary/5">
              <CardContent className="p-8">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-primary">{t('profile.professionalServices')}</h3>
                </div>
                
                <div className="mb-6 p-4 bg-white rounded-lg shadow-sm">
                  <div className="text-xl font-bold mb-2 text-primary">{t('profile.standardRate')}</div>
                  <div className="text-3xl font-bold text-secondary mb-2">{t('profile.rateValue')}</div>
